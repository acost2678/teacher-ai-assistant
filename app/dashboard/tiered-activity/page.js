...
export default function TieredActivityPage() {
  ...
  const handleShowDemo = () => {
    ...
    setSubject('Math')
    setTopic('Multiplying Fractions')
    setLearningObjective('Students will be able to multiply fractions by whole numbers and other fractions using visual models and the standard algorithm.')
    setActivityType('practice')
    setTieringStrategy('readiness')
    setIncludeRubric(true)
    setIncludeMaterials(true)
    setIncludeGroupingTips(true)
    setShowDemo(true)
          ...
          <div className="bg-purple-50 border-l-4 border-purple-500 rounded-r-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-purple-600 text-sm">We've filled in a 4th grade math example for multiplying fractions. Click Generate to see tiered activities.</p>
              </div>
