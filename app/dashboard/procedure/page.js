...
export default function ProcedurePage() {
  ...
  const handleShowDemo = () => {
    ...
    setProcedureType('transitions')
    setCustomProcedure('')
    setClassContext('28 students, self-contained classroom, transitions between subjects happen 6-8 times daily, some students need extra support with changes')
    setIncludeVisuals(true)
    setIncludeTeachingScript(true)
    setIncludePracticeSchedule(true)
    setIncludeReinforcement(true)
    setShowDemo(true)
  ...
  const handleResetDemo = () => {
    setGradeLevel('3rd-5th Grade')
    setProcedureType('entering-class')
    setCustomProcedure('')
    setClassContext('')
    setIncludeVisuals(true)
    setIncludeTeachingScript(true)
          ...
          <div className="bg-purple-50 border-l-4 border-purple-500 rounded-r-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-purple-600 text-sm">We've filled in a transitions procedure for 3rd-5th grade. Click Generate to see the full procedure with teaching script.</p>
              </div>
