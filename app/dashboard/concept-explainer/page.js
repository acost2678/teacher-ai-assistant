...
export default function ConceptExplainerPage() {
  ...
  const handleShowDemo = () => {
    ...
    setConcept('Adding fractions with unlike denominators')
    setPriorKnowledge('Equivalent fractions, understanding that fractions represent parts of a whole')
    setRepresentations(['concrete', 'visual', 'abstract', 'real-world'])
    setAudienceType('student')
    setIncludeCommonMistakes(true)
  ...
  const handleResetDemo = () => {
    ...
    setConcept('')
    setPriorKnowledge('')
    setRepresentations(['concrete', 'visual', 'abstract'])
    setAudienceType('student')
    setIncludeCommonMistakes(true)
    setIncludeRealWorld(true)
    setIncludeVocabulary(true)
          ...
          <div className="bg-purple-50 border-l-4 border-purple-500 rounded-r-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-purple-600 text-sm">We've filled in "Adding fractions with unlike denominators". Click Generate to see a CRA explanation.</p>
              </div>
